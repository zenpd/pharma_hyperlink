...
from hyperlink_engine.pipeline.batch_runner import BatchRunReport
from hyperlink_engine.reporting.readiness_score import (
    ReadinessResult,
    ScoringWeights,
    _compute_score,
    _grade,
...
def test_perfect_dossier_is_submission_ready(tmp_path: Path) -> None:
    from hyperlink_engine.pipeline.batch_runner import BatchRunReport, DossierBatchDescriptor, run_batch
