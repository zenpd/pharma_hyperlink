...
from hyperlink_engine.core.ingestion.ectd_loader import EctdLoadError, load_backbone
...
def test_module_label_for_unknown_path() -> None:
    from hyperlink_engine.core.ingestion.ectd_loader import _leaf_module
