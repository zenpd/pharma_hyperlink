...
from hyperlink_engine.core.parsing.docx_parser import (
    candidate_blue_runs,
    parse_docx,
)
...
def styled_docx(tmp_path: Path) -> Path:
    ...
    doc.add_paragraph("Reference to Section 2.5.3 here.")
...
def test_blueish_helper_thresholds() -> None:
    ...
    from hyperlink_engine.core.parsing.docx_parser import _is_blueish
