...
CSR_004 = CsrDoc(
    ...
    sections=[
        Section(
            ...
            level=1,
            paragraphs=[
                "This confirmatory Phase 3 study was designed based on data from the "
...
def _write_manifest(out_dir: Path, doc_paths: list[Path]) -> Path:
    lines = [
        ...
        "Cross-doc references: 12 (3 per document)",
        "",
        "Files:",
    ]
    for p in doc_paths:
...
def main() -> None:
    ...
    out.write("  Cross-refs : 12 (3 per document, all cross-doc)\n")
