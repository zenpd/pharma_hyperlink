...
from hyperlink_engine.core.reporting.readiness_score import ScoringWeights, compute_readiness_score
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Aggregate CSV — write one only if the batch didn't already produce it
    if not (batch_report.aggregate_csv and batch_report.aggregate_csv.exists()):
        ...
        write_link_records(all_records, reports_dir / "dossier_links.csv")
    ...
    # XLSX report
    try:
        from hyperlink_engine.core.reporting.xlsx_exporter import write_xlsx_report  # noqa: PLC0415
