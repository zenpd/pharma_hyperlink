...
Events are emitted by node functions and consumed by:
  - Streamlit: via on_event callback in synchronous mode
...
class _EventBus:
    ...
    def __init__(self) -> None:
        ...
        # Threading queues for sync consumers (Streamlit callback)
    ...
    def subscribe_sync(self, run_id: str, callback: Callable) -> None:
        """Register a synchronous callback (for Streamlit)."""
        with self._lock:
